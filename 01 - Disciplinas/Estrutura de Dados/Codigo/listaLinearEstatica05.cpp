/*******************************************************************************************************
* Lista Linear Sequencial - caso de uso com interação com o usuario e novos campos: nome idade e cpf   *
* listaLinearEstatica05.cpp                                                                            *
********************************************************************************************************/
#include <iostream>
#include <string>
#include <iomanip>
...
void imprimirLista(LISTA *l){
    ...
    cout <<"\n\nLista  \n";
    cout <<"|-----------|------------------------------------------------------------|--- -|---------------|\n";
    cout <<"|    RA     |                     Nome                                   |idade|      CPF      |\n";
    cout <<"|-----------|------------------------------------------------------------|---- |---------------|\n";
    for (i=0; i< l->nroElem; i++)
        cout << "| " <<setw(10)<<l->A[i].chave<<
         "|" <<left<<setw(60)<<l->A[i].nome<<right<< "|" <<
         setw(5)<<l->A[i].idade<< "|" <<setw(15)<<l->A[i].cpf<< "|" << endl;
    cout <<"|-----------|------------------------------------------------------------|---- |---------------|\n";
    cout <<"\n";
}
        ...
        switch (op){
            ...
            case 6 :
                ...
                if (pos == -1) 
                    ...
                    cout << "Elemento " << reg1.chave << " encontra-se na posição " << pos << endl
                             << endl;
                getchar();
                getchar();
                break;
