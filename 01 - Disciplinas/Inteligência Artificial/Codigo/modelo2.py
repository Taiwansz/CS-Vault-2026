# -*- coding: utf-8 -*-
"""
Jogo da Velha com Tkinter — v2 (Painel/Heatmap + Auto‑Treino)
-----------------------------------------------------------------
...
• NOVO: Heatmap/percentuais por casa (previsão do humano) + Auto‑Treino (simulação).
...
class App:
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Jogo da Velha — IA Minimax + Aprendizado de Oponente (v2)")
    ...
    def _desenhar_probabilidades(self):
        ...
        for i, p in probs.items():
            ...
            # retângulo preenchido com cor interpolada (branco -> azul clarinho)
        ...
        for _ in range(max(1, int(n))):
            ...
            while True:
                ...
                if turno == self.humano:
                    ...
                    # Usa a própria previsão do modelo; se nula, heurística simples
                    pred = self.modelo_op.prever(estado, livres)
